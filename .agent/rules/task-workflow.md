...
- Whenever the user issues a `/propose` command, you MUST initialize the `tasks.md` file using the template found in `/openspec/templates/openspec-task-template.md.`.
